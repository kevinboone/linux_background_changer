...
/** Make a new list from the randomized contents of this one. 
 * CAUTION: the new list contains references to the elements in the
 * old one. The old list cannot easily clear cleared. Most callers
 * should use klist_shuffle() instead. */
extern KList *klist_new_shuffled (const KList *self);
...
/** Randomize the list. Seed the random number generator before use. */
extern void   klist_shuffle (KList *self); 
